...
-- ============================================================
-- 7. FUNCIÓN PARA CANCELAR TICKET (restaura stock, eliminación atómica)
-- ============================================================
...
-- ============================================================
-- 8. FUNCIÓN PARA ACTUALIZAR TICKET (ajusta stock de forma atómica)
-- ============================================================
create or replace function actualizar_ticket(
  p_ticket_id    uuid,
  p_nuevo_total  numeric,
  p_nuevos_items jsonb  -- array de {producto_id, nombre_producto, precio_unitario, cantidad, total_linea, con_oferta, detalle_oferta}
) returns void as $$
declare
  v_caseta_id uuid;
  v_item      record;
...
-- ============================================================
-- 9. FUNCIÓN PARA VERIFICAR CAJA ABIERTA EN CASETA
-- ============================================================
